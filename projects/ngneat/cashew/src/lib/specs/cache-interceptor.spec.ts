...
//     handle: jest.fn(() => timer(frame).pipe(map(() => new HttpResponse({ body: response }))))
//   });
...
//       call(
//         request({
//           clearCachePredicate<T>(previousRequest: HttpRequest<T> | undefined, currentRequest: HttpRequest<T>): boolean {
