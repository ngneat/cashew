...
export abstract class TTLManager {
  abstract isValid(request: HttpCacheRequest): boolean;
  abstract set(request: HttpCacheRequest, ttl?: number): void;
}
